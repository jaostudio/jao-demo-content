...
export default function ProductError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="mx-auto max-w-3xl px-4 py-24 text-center">
      ...
      <h1 className="mt-6 text-2xl font-bold">Hala, nag-error!</h1>
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-4">
        ...
        <Link href="/products" className="inline-flex h-11 items-center justify-center rounded-xl border border-subtle px-6 text-sm font-semibold transition-colors hover:border-subtle">
          Bumalik sa Tinda
        </Link>
      </div>
    </div>
